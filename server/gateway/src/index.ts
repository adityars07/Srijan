  ...
  try {
    ...
    res.json({
      metrics: {
        ...
        lowStockCount: productData.outOfStock || 0,
        totalOrders: orderData.totalOrders || 0,
        totalRevenue: orderData.totalRevenue || 0,
        totalRevenueINR: orderData.totalRevenue || 0,
        totalRevenueUSD: Math.round((orderData.totalRevenue || 0) / 83),
        pendingOrders: orderData.pendingOrders || 0,
        completedOrders: orderData.completedOrders || 0,
        orderStatusCounts: {
          IN_CRAFTING: orderData.pendingOrders || 0,
          DELIVERED: orderData.completedOrders || 0,
          CONFIRMED: orderData.totalOrders ? Math.max(0, orderData.totalOrders - (orderData.completedOrders || 0)) : 0,
        },
        totalCommissions: commData.totalCommissions || 0,
        pendingCommissions: commData.pendingCommissions || 0,
        pendingCustomRequests: commData.pendingCommissions || 0,
